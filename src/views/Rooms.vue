    ...
    <div class="row">
      <div class="col d-flex flex-column justify-content-center illustration-side">
        <div class="align-self-center">
          <img class="waiting-illustration" src="https://www.pngarts.com/files/1/Waiting-Room-PNG-Image.png" alt="">
          <h1 class="text-muted waiting-room-title">Ruang tunggu ...</h1>
        </div>
      </div>
        ...
        <div class="card rooms-card">
          <div class="card-body d-flex flex-column justify-content-center">
            <div class="align-self-center">
              ...
              <h5 v-if="isStart" class="waiting-info text-muted">Current game is running, please wait</h5>
            </div>
          </div>
        </div>
      </div>
